...
const unfundedGamesString = totalunFundedGames === 1 
      ? "we have 1 game that still needs funding." 
      : `${totalunFundedGames} games remain unfunded.`;

const displaystr = 
  `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. 
  Currently, ${unfundedGamesString} We need your help to fund these amazing games!`;
